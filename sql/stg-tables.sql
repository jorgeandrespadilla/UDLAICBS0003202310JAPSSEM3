...
ALTER TABLE CHANNELS_EXT 
	ADD CONSTRAINT CHANNELS_EXT_PK PRIMARY KEY (CHANNEL_ID);
...
ALTER TABLE COUNTRIES_EXT
	ADD CONSTRAINT COUNTRIES_EXT_PK PRIMARY KEY (COUNTRY_ID);
...
ALTER TABLE CUSTOMERS_EXT
    ADD CONSTRAINT CUSTOMERS_EXT_PK PRIMARY KEY ( CUST_ID );
...
ALTER TABLE PRODUCTS_EXT
    ADD CONSTRAINT PRODUCTS_EXT_PK PRIMARY KEY ( PROD_ID ) ;
...
ALTER TABLE PROMOTIONS_EXT
    ADD CONSTRAINT PROMOTIONS_EXT_PK PRIMARY KEY ( PROMO_ID ) ;
...
ALTER TABLE TIMES_EXT
    ADD CONSTRAINT TIMES_EXT_PK PRIMARY KEY ( TIME_ID ) ;
